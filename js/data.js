...
const TOOLS = [
  ...
  },
  {
    ...
    status: "exp",
    statusLabel: "Experimental",
    summary: "Inspect a FiveM resource folder in the browser and get a plain-English report on scripts, NUI, stream files, metadata, dependencies, and likely issues.",
    description: "The inspector examines the files in a selected resource folder and explains what kind of resource it appears to be, including client and server roles, NUI usage, stream assets, metadata files, and dependency hints.",
    ...
    visibility: "Public",
    builtIn: true,
    notes: "Runs locally in the browser. Detection is a helper, not a replacement for testing the resource in FiveM.",
  },
];
